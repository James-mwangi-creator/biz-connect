...
export default function App() {
  return (
    <ScrollView style={styles.container}>
      <StatusBar style="light" backgroundColor="#2F5496" />
      
      <View style={styles.header}>
        <Text style={styles.title}>Biz Connect</Text>
        <Text style={styles.subtitle}>A platform for business professionals to network, collaborate, and grow their ventures</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={[styles.button, {backgroundColor: '#2F5496'}]}>
